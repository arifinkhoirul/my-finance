...
function update() {
    form.put(route('investasi.update', page.props.dataTransaksi.id))
}
    ...
    <div class="min-h-screen bg-background pb-8">
        <div class="sticky top-0 z-40 bg-background/50 backdrop-blur-lg border-b border-border">
            <div class="mx-auto max-w-lg px-4 py-4">
                <div class="flex items-center gap-4 ">
                    <Link :href="route('investasi.all')" @click="goBack()">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-lg font-bold text-foreground">Edit Investasi</h1>
        ...
        <form @submit.prevent="update" class="mx-auto max-w-lg px-4 pt-6 space-y-6">
            ...
            <button type="submit"
                ...
                {{ form.processing ? 'Menyimpan..' : 'Simpan Investasi' }}
            </button>
        </form>
    </div>
</template>
